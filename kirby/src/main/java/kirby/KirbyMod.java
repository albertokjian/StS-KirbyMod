...
import kirby.relics.DefaultClickableRelic;
import kirby.relics.PlaceholderRelic;
import kirby.relics.PlaceholderRelic2;
import kirby.util.IDCheckDontTouchPls;
...
public class KirbyMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "kirbyResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "kirbyResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "kirbyResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "kirbyResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "kirbyResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "kirbyResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "kirbyResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "kirbyResources/images/1024/bg_power_default_gray.png";
    ...
    public KirbyMod() {
      ...
      */
        ...
        // 1. Go to your resources folder in the project panel, and refactor> rename kirbyResources to
        // yourModIDResources.
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = KirbyMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = KirbyMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = KirbyMod.class.getPackage().getName(); // STILL NO EDIT ZONE
