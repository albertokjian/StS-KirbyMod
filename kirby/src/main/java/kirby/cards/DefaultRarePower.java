...
import kirby.powers.RarePower;

import static kirby.KirbyMod.makeCardPath;

public class DefaultRarePower extends AbstractKirbyCard {
    ...
    public static final String ID = KirbyMod.makeID(DefaultRarePower.class.getSimpleName());
