...
// Skip this question until you start figuring out the AbstractDefaultCard/AbstractKirbyCard and just extend DynamicCard
...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = KirbyMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main KirbyMod.java file in the
