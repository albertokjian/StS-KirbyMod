...
public class CardTemplate extends AbstractDynamicCard {
    ...
    // public static final String ID = KirbyMod.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = KirbyMod.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
