...
public class DefaultSecondMagicNumberSkill extends AbstractKirbyCard {
    ...
    public static final String ID = KirbyMod.makeID(DefaultSecondMagicNumberSkill.class.getSimpleName());
