...
public class DefaultAttackWithVariable extends AbstractKirbyCard {
    ...
    public static final String ID = KirbyMod.makeID(DefaultAttackWithVariable.class.getSimpleName());
