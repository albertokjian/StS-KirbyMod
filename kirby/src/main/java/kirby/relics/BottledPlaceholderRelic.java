...
import kirby.patches.relics.BottledPlaceholderField;
import kirby.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static kirby.KirbyMod.makeRelicOutlinePath;
import static kirby.KirbyMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = KirbyMod.makeID("BottledPlaceholderRelic");
