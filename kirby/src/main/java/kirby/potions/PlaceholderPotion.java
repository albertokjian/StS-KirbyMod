...
public class PlaceholderPotion extends CustomPotion {
    ...
    public static final String POTION_ID = KirbyMod.makeID("PlaceholderPotion");
    ...
    public PlaceholderPotion() {
        // The bottle shape and inside is determined by potion size and color. The actual colors are the main KirbyMod.java
